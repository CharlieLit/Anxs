...
if wget -q https://github.com/CharlieLit/Anxs/raw/master/musicSH/"$random_mp3"; then
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} GeriPium5${b}: "
	read opcion
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/FNtD1vGHoFrHdD0tZPJdSt &>> /dev/null
...
echo -e "\033[01;32m\033[01mIniciando GeriPium!!\nStarting GeriPium!!\n\033[0m"
npm start
